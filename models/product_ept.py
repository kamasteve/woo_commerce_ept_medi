...
class WooProductTemplateEpt(models.Model):
    ...
    def get_product_price(self, instance, variant):
        ...
        Migrated Maulik Barad on Date 07-Oct-2021.
        """
        vals = {'regular_price': str(instance.woo_pricelist_id._get_product_price(variant.product_id, 1.0))}
        if instance.woo_extra_pricelist_id:
            vals.update(
                {'sale_price': str(instance.woo_extra_pricelist_id._get_product_price(variant.product_id, 1.0))})
        return vals
